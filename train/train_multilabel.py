...
ART = os.path.join(ROOT, "../../datasets/Datasets-NLP/blocktroll_dataset")
BAL_ART = os.path.join(ROOT, "../../datasets/Datasets-NLP/blocktroll_dataset_balanced")
...
def main():
    ...
    args = TrainingArguments(
        output_dir=os.path.join(ROOT, "../../models/Model-NLP/blocktroll-koelectra/runs"),
        learning_rate=2e-5,
